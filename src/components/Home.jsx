                ...
                <div className="home__container container grid">
                    <div className="home__content grid">
                        <div className="home__social">
                            <a href="https://www.linkedin.com/in/wildan-wildiansyah-3b3a68171/" target="_blank" className="home__social-icon">
                                <Unicons.UilLinkedinAlt/>
                            </a>
                            {/* <!-- <a href="https://iconscout.com/unicons/explore/line" target="_blank" className="home__social-icon">
                                <i className="uil uil-dribbble"></i>
                            </a> --> */}
                            <a href="https://github.com/wildannajahw" target="_blank" className="home__social-icon">
                        ...
                        <div className="home__data">
                            <h1 className="home__title">Hi, I'am Wildan</h1>
                            <h3 className="home__subtitle">Frontend Developer</h3>
                            <p className="home__description">
                                High level experience in web design and knowledge, producing quality work
                            </p> <br />
                            <a href="#contact" className="button button--flex">
                                Contact Me <Unicons.UilMessage className="button__icon"/>
